...
// import { StyleSheet, Text, View, Image, FlatList, ActivityIndicator, Button, Linking } from 'react-native';
...
// // // ✅ Share via Instagram Direct Message (DM)
...
// //         Linking.openURL(url);
// //       } else {
// //         alert("Instagram is not installed on this device.");
// //       }
// //     })
...
// const shareViaSMS = () => {
//   const message = `Check out this destination: ${name}!\n\n${description}\nLocation: ${country}\nMore info: ${destinationLink}`;
//   const phoneNumber = "+12263774462"; // Replace with a dynamic number if needed
...
//             {/* <Button title="Share via Instagram" onPress={shareViaInstagram} color="purple"/> */}
//             <Button title="Share via SMS" onPress={shareViaSMS} color="blue" />
//           </View>
//         </>
//       )}
